...
from mmdet.utils import (build_ddp, build_dp, compat_cfg, get_device,
                         ...
                         update_data_root)
from projects.instance_segment_anything import *
...
def main():
    ...
    if hasattr(cfg, 'plugin'):
        if cfg.plugin:
            import importlib
            if hasattr(cfg, 'plugin_name') and hasattr(cfg, 'plugin_package'):
                plugin_name = cfg.plugin_name
                plugin_package = cfg.plugin_package
                plg_lib = importlib.import_module(plugin_name,package=plugin_package)
